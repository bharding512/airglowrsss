function output = ge_picassoimage(lon,lat,alt,data,clim,timestamp_0, timestamp_1, path_stub, filename)
%
% Saves a PICASSO image a format acceptable to Google Earth.
%
% INPUTS
...
%   yyyy-mm-ddThh:mm:sszzzzzz format.  This is a string.
%   path_stub - directory to save everything to
...
imwrite(da, sprintf('%s%s', path_stub, filename), 'PNG', 'Alpha', alpha);

% Create the output to be written to a kml file

output = ['<GroundOverlay>\n',...
          '  <name>PICASSO Image</name>\n',...
          '  <Region>\n',...
          '    <LatLonAltBox>\n',...
