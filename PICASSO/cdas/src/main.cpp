...
/*      if(mySystem.myConfiguration.myCameraType == APOGEE)
    ...
    case GET_STARTTIME:
      ...
      sout << mktime(&mySystem.myConfiguration.mySchedule.GetStartTime());
      *result = sout.str();
      break;
    case GET_STOPTIME:
      // return the stoptime
      sout << mktime(&mySystem.myConfiguration.mySchedule.GetStopTime());
      *result = sout.str();
      break;
    case GET_SITENAME:
      // return the sitename
...
// 		mySystem.myConfiguration.myFilterWheel = new FilterWheelFLI();
	...
	mySystem.myConfiguration.myFilterWheel->OpenShutter();
         ...
         while(now < mktime(&temp_time) &&
               ...
               now >= mktime(&mySystem.myConfiguration.mySchedule.GetStartTime()))
         {
