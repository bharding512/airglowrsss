...
#ifndef FILTERWheelFLI_H
#define FILTERWheelFLI_H
...
class FilterWheelFLI : public FilterWheel  {
public:
	FilterWheelFLI();
	~FilterWheelFLI();
  /** No descriptions */
...
private:
  /** Yeah, it's a C-string...the FLI driver talks C.  So, we will, too. */
