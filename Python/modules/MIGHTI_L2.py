...
# Slightly updated logic in v6.03, for compatibility with local env, not important for wider use.
...
try:
    ...
    try:
        ...
        try:
            ...
            msis_function = None
            print("WARNING: pymsis present but unusable (e.g., NumPy ABI issue)")
