...
if __name__=="__main__":
    ...
    # Set warning limits
    hoursback = 30  # Must be slightly longer than 24 hrs - allows transfer time to be sluggish. Probably less than 30 hrs so warnings don't come after we've left work.
